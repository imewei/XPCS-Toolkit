...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.saxs2d_autolevel.setObjectName(u"saxs2d_autolevel")
        ...
        self.gridLayout_40.addWidget(self.horizontalSlider_saxs2d_selection, 0, 1, 1, 10)
        ...
        self.pushButton_plot_saxs1d.setObjectName(u"pushButton_plot_saxs1d")
        sizePolicy7 = QSizePolicy(QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)
        sizePolicy7.setHorizontalStretch(0)
        sizePolicy7.setVerticalStretch(0)
        sizePolicy7.setHeightForWidth(self.pushButton_plot_saxs1d.sizePolicy().hasHeightForWidth())
        ...
        self.pushButton_plot_intt.setObjectName(u"pushButton_plot_intt")
        ...
        self.comboBox_qmap_target.addItem("")
        self.comboBox_qmap_target.addItem("")
        self.comboBox_qmap_target.setObjectName(u"comboBox_qmap_target")
        ...
        self.pg_qmap.setObjectName(u"pg_qmap")
        ...
        self.cb_saxs2D_cmap.currentIndexChanged.connect(self.pushButton_plot_saxs2d.click)
        ...
        self.cb_stab_norm.currentIndexChanged.connect(self.pushButton_plot_stability.click)
        ...
        self.saxs1d_legend_loc.currentIndexChanged.connect(self.pushButton_plot_saxs1d.click)
        ...
        self.saxs1d_lb_type.currentIndexChanged.connect(self.pushButton_plot_saxs1d.click)
    ...
    def retranslateUi(self, mainWindow):
        mainWindow.setWindowTitle(QCoreApplication.translate("mainWindow", u"XPCS Toolkit", None))
        ...
        self.saxs2d_autolevel.setText(QCoreApplication.translate("mainWindow", u"autolevel", None))
        ...
        self.saxs1d_legend_loc.setItemText(0, QCoreApplication.translate("mainWindow", u"upper right", None))
        self.saxs1d_legend_loc.setItemText(1, QCoreApplication.translate("mainWindow", u"upper center", None))
        self.saxs1d_legend_loc.setItemText(2, QCoreApplication.translate("mainWindow", u"upper left", None))
        self.saxs1d_legend_loc.setItemText(3, QCoreApplication.translate("mainWindow", u"center right", None))
        self.saxs1d_legend_loc.setItemText(4, QCoreApplication.translate("mainWindow", u"center", None))
        self.saxs1d_legend_loc.setItemText(5, QCoreApplication.translate("mainWindow", u"center left", None))
        self.saxs1d_legend_loc.setItemText(6, QCoreApplication.translate("mainWindow", u"lower right", None))
        self.saxs1d_legend_loc.setItemText(7, QCoreApplication.translate("mainWindow", u"lower center", None))
        self.saxs1d_legend_loc.setItemText(8, QCoreApplication.translate("mainWindow", u"lower left", None))
        ...
        self.comboBox_qmap_target.setItemText(2, QCoreApplication.translate("mainWindow", u"scattering", None))

        self.label_27.setText(QCoreApplication.translate("mainWindow", u"Target", None))
