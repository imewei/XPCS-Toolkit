...
from tests.coverage_manager import CoverageManager, CoverageReport, CoverageMetrics
...
class TestCoverageReporting(unittest.TestCase):
    ...
    def test_trend_analysis_structure(self):
        ...
        required_keys = ['timestamps', 'overall_coverage', 'branch_coverage',
                        'target_success_rate', 'profiles']
