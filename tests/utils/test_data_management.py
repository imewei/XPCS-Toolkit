...
class TestDataCache:
    ...
    def __init__(self, cache_dir: Optional[Path] = None, max_cache_mb: float = 100.0):
    ...
    def get(self, spec: TestDataSpec) -> Optional[Dict[str, Any]]:
...
class AdvancedTestDataFactory:
    ...
    def __init__(self, cache: Optional[TestDataCache] = None):
    ...
    def _generate_xpcs_data(self, spec: TestDataSpec) -> Dict[str, Any]:
        ...
        if spec.size_mb is not None:
            ...
            total_elements = int((spec.size_mb * 1024 * 1024) / 8)  # 8 bytes per float64
    ...
    def _generate_qmap_data(self, spec: TestDataSpec) -> Dict[str, Any]:
        ...
        return {
            ...
            **{k: v for k, v in detector_data.items()
...
class HDF5TestDataManager:
    ...
    def __init__(self, factory: Optional[AdvancedTestDataFactory] = None):
    ...
    def create_xpcs_file(
        ...
        with h5py.File(file_path, 'w') as f:
            ...
            if 'correlation' in generated_data:
                ...
                multitau.create_dataset('g2_err', data=np.tile(corr_data['g2_err'], (n_q, 1)))
            ...
            if 'xpcs' in generated_data:
                ...
                multitau.create_dataset('saxs_2d',
...
def create_performance_test_data(size_mb: float = 10.0, seed: int = 42) -> Dict[str, Any]:
