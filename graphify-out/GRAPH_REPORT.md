...
## Corpus Check
- 357 files · ~611,663 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 12069 nodes · 19149 edges · 665 communities (492 shown, 173 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 2441 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `330090ce`
...
## Communities (665 total, 173 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (85): Recompute Q-map from current metadata.          Returns:             Tuple of (q, Execute undo/redo/reset on mask history.          Args:             action: One, Apply a mask type and update current mask.          Args:             target: Ma, Save mask to HDF5 file.          Args:             save_name: Output file path (, Load mask from HDF5 file.          Args:             fname: Path to HDF5 file, Display pixel coordinates and Q values at mouse position.          Args:, Apply all pending drawing ROIs to create a mask.          Returns:             M, Core kernel for SimpleMask operations.      This class manages mask creation, ed (+77 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (140): ABC, dtype, Enum, AccessPattern, CacheEntry, get_enhanced_hdf5_reader(), get_enhanced_reader(), IntelligentChunker (+132 more)
...
Cohesion: 0.05
Nodes (21): create_param_tree(), Return False and show guidance when no target data is available., Update only the G2 profile when Q-bin changes., Plot the G2 Map visualization., Plot G2 correlation functions with optional fitting.          Generates multi-ta, Refit G2 correlation functions with force_refit=True to bypass cache.          T, Plot G2 correlation functions with fitting overlay on the g2 fitting tab., Export power law fitting results from diffusion analysis. (+13 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (26): Test suite for ViewerKernel edge cases and error conditions., Test handling of empty path., Test handling of None statusbar., Test handling of nonexistent path., Test suite for ViewerKernel metadata management., Test reset_meta creates correct metadata structure., Test that reset_meta maintains dictionary type., TestViewerKernelEdgeCases (+18 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (46): main, main_gui, setting, register_shortcut should accept QKeySequence., take_snapshot, QKeySequence, Ui, Restore workspace state from saved session. (+38 more)

### Community 9 - "Community 9"
Cohesion: 0.07
Nodes (19): Unit tests for ViewerKernel class.  This module provides comprehensive unit test, Test suite for ViewerKernel properties and attributes., Test path property access., Test statusbar property access., Test suite for ViewerKernel weak reference handling., Test that weak reference cache behaves correctly., Test suite for ViewerKernel string representations., Test that ViewerKernel class has proper docstring. (+11 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (42): MockH5py, MockH5pyFile, Data validation error handling tests.  This module tests error conditions relate, Test handling of incompatible data types., Test handling of infinite and NaN values in data., Test handling of negative values where positive are expected., Test data range validation errors., Test handling of extremely large numerical values. (+34 more)
...
Cohesion: 0.13
Nodes (15): module.saxs1d, module.saxs2d, arrays_compatible(), get_array_backend(), is_jax_array(), is_numpy_array(), Array conversion utilities for I/O boundaries.  This module provides functions f, Check if array is a JAX array.      Parameters     ----------     array : Any (+7 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (72): create_test_mask(), create_test_phi_map(), create_test_qmap(), Tests for partition numerical equivalence between NumPy and JAX backends.  This, Test that JAX produces identical linear partition to NumPy., Test that JAX produces identical logarithmic partition to NumPy., Test that JAX produces identical phi partition to NumPy., Test phi partition with offset produces identical results. (+64 more)

### Community 14 - "Community 14"
Cohesion: 0.07
Nodes (33): calculate_multiple_rois_parallel(), calculate_ring_roi(), ParallelROIProcessor, Process ROI calculation using streaming for memory efficiency., Process a single chunk with vectorized operations., Process pie ROI chunk with q-value binning., Process ring ROI chunk with angular binning., Generate x-axis values based on ROI type. (+25 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (97): ArrayLike, NLSQ single_exp cold: 1830.3ms, warm: 463.0ms, fit_double_exp(), fit_power_law(), fit_single_exp(), fit_stretched_exp(), grad(), nlsq_fit() (+89 more)
...
Cohesion: 0.03
Nodes (59): Q-map 512x512 cold: 134.8ms, warm: 4.28ms, Test Q-map computation works on CPU., large_array(), Benchmark tests for Q-map computation (T061).  Benchmarks for measuring JIT spee, Benchmarks for Q-map computation., Benchmark Q-map on small detector (256x256)., Benchmark Q-map on medium detector (512x512)., Benchmark Q-map on large detector (1024x1024). (+51 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (94): BUG-007: Signal emissions from ThreadPoolExecutor threads must use invokeMethod, folder-open icon, grid-mask icon, refresh icon, QObject, QThreadPool, AsyncViewerKernel, _on_plot_ready() (+86 more)
...
Cohesion: 0.09
Nodes (25): EnhancedHDF5Reader, get_dataset_info(), get_file_connection(), Intelligent read-ahead cache for HDF5 data based on access patterns., Record an access for pattern analysis., Predict next likely access patterns for read-ahead.          Parameters, Check if recent accesses show sequential pattern., Check if accesses show sliding window pattern. (+17 more)
...
Cohesion: 0.03
Nodes (48): Any, Execute body function in a loop from lower to upper.          Sequential fallbac, Get cache statistics., Get comprehensive performance statistics., Tests for type annotations in helper/utils.py (Task T064).  This test verifies t, Verify norm_saxs_data returns correct tuple., Verify create_slice returns a slice object., Test that typed functions work correctly. (+40 more)

### Community 24 - "Community 24"
Cohesion: 0.06
Nodes (34): HDF5ConnectionPool, Enhanced connection pool for HDF5 files with LRU eviction, health monitoring,, Close all connections and clear the pool., Unit tests for HDF5 reader module.  This module provides comprehensive unit test, Test suite for HDF5ConnectionPool initialization., Test HDF5ConnectionPool initialization with default parameters., Test HDF5ConnectionPool initialization with custom parameters., Test suite for HDF5ConnectionPool basic operations. (+26 more)
...
Cohesion: 0.04
Nodes (46): BUG-006 HDF5 g2 shape axis, Dummy Q values are sequential integers 0..n_q-1., Missing Q values in HDF5 produce correct number of dummy Q entries (BUG-006 entr, read_g2_data generates len(n_q) dummy Q values when q_values key is missing., _decode_h5_unit(), HDF5Facade, HDF5ValidationError, Unified HDF5 I/O facade with schema validation.  This module provides a high-lev (+38 more)
...
Cohesion: 0.08
Nodes (25): Integration tests for comprehensive logging system.  Tests verify: - JSON format, Verify JSON fields have correct types for aggregation systems., Verify exception information is properly structured., Test session context correlation across log entries (T092)., Verify all logs within a context share the same session_id., Verify nested contexts maintain session continuity., Test JSON formatter produces valid schema for log aggregation (T077)., Verify JSON formatter output is parseable JSON. (+17 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (29): MockH5py, MockH5pyFile, Comprehensive file I/O error handling tests.  This module tests error conditions, Test pooled connection health checking with file deletion., Test XpcsFile error handling., Test XpcsFile initialization with invalid file., Test XpcsFile initialization with missing file., Test lazy loading error handling in XpcsFile. (+21 more)

### Community 31 - "Community 31"
Cohesion: 0.10
Nodes (17): compute_qmap, compute_reflection_qmap, compute_transmission_qmap, compute_reflection_qmap(), Compute Q-map for reflection (grazing incidence) geometry.      Args:         en, Regression tests for Q-map pixel index correctness.  These tests verify that qma, Tests for pixel indices in reflection Q-map., Standard detector geometry for reflection testing. (+9 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (50): safe_shutdown, Test minimal XpcsFile initialization., Test XpcsFile initialization with custom qmap manager., Test XpcsFile initialization with extra fields., Test suite for XpcsFile string representations., Test __repr__ method., Test suite for XpcsFile data access methods., Test get_hdf_info method. (+42 more)
...
Cohesion: 0.05
Nodes (33): cancel_all(), OperationInfo, ProgressDialog, ProgressIndicator, ProgressManager, Progress management system for XPCS Viewer.  This module provides progress indic, Update the progress indicator., Calculate and update estimated time to completion. (+25 more)
...
Cohesion: 0.09
Nodes (33): CLI modules for XPCS Viewer., get_cleanup_system(), initialize_optimized_cleanup(), Get or create the global cleanup system instance., Schedule a cleanup task., Schedule a cleanup task., Shutdown optimized cleanup system (alias for cleanup_system_shutdown)., Initialize the optimized cleanup system. (+25 more)

### Community 39 - "Community 39"
Cohesion: 0.02
Nodes (113): BaseAsyncWorker, BasePlotWorker, tab-correlation icon, tab-scattering icon, QRunnable, AsyncDataPreloader, compute_async(), load_files_async() (+105 more)

### Community 40 - "Community 40"
Cohesion: 0.01
Nodes (133): BUG-024: FitResult __post_init__ validation, BUG-025: FitDiagnostics __post_init__ validation, BUG-026: Legacy model factory get_backend once, FitDiagnostics, FitResult, FitDiagnostics, FitResult, Convergence diagnostics for MCMC sampling.      Attributes     ----------     r_ (+125 more)
...
Cohesion: 0.04
Nodes (79): generate_synthetic_c2_matrix(), generate_synthetic_saxs_2d(), Generate synthetic two-time correlation (C2) matrix.      Args:         size: Ma, Generate synthetic SAXS 2D detector image with ring patterns.      Args:, auto_performance_monitoring(), configure_ci_environment(), configure_test_environment(), corrupted_hdf5_file() (+71 more)

### Community 45 - "Community 45"
Cohesion: 0.05
Nodes (22): Unit tests for XpcsFile class.  This module provides comprehensive unit tests fo, Test that correct fields are loaded based on analysis type., Test suite for create_id function., Test create_id function is called with correct parameters., Test suite for XpcsFile performance characteristics., Test XpcsFile initialization completes within reasonable time., Test suite for XpcsFile edge cases and error conditions., Test handling of empty data arrays. (+14 more)
...
Cohesion: 0.02
Nodes (126): Exception, chain_exception, convert_exception, handle_exceptions, number, StateValidationLevel, chain_exception(), convert_exception() (+118 more)
...
Cohesion: 0.02
Nodes (82): CurveFitResult (native NLSQ 0.6.0), NLSQResult, Result from nonlinear least squares fitting.      This class wraps NLSQ 0.6.0's, Initialize param names from params dict if not provided., Coefficient of determination (R²)., Set r_squared (for backward compat initialization).          Note: This setter i, Adjusted R² accounting for number of parameters., Set adj_r_squared (for backward compat initialization).          Note: This sett (+74 more)

### Community 60 - "Community 60"
Cohesion: 0.08
Nodes (20): BayesianDiagnosisWindow, ConvergenceSummaryWidget, Bayesian diagnosis window for MCMC fit results.  Provides a shared diagnostic wi, Diagnostic window showing Bayesian fit results and MCMC diagnostics.      Reused, Set axis labels for the posterior predictive plot., Refresh all panels with new fit results.          Parameters         ----------, Redraw the posterior predictive plot (Tab 1)., Redraw ArviZ diagnostic plots (Tab 2). (+12 more)

### Community 62 - "Community 62"
Cohesion: 0.07
Nodes (41): _add_labeled_spinbox(), apply_all_layout_improvements(), _apply_compact_density_to_sidebars(), apply_group_box_styling(), create_separator(), improve_control_panel_layout(), improve_file_panel_layout(), improve_tab_content_spacing() (+33 more)
...
Cohesion: 0.25
Nodes (5): Test statistical properties of fitting algorithms, Test analysis of parameter correlations in fitting, Test that confidence intervals have correct coverage probability, Test statistical properties of fitting residuals, TestFittingStatisticalValidation
...
Cohesion: 0.05
Nodes (27): Test data format validation error handling., TestDataFormatValidationErrors, MockH5py, MockH5pyFile, Edge case and boundary condition tests.  This module tests boundary conditions,, Test handling of arrays at maximum reasonable dimensions., Test handling of minimum positive floating point values., Test handling of maximum finite floating point values. (+19 more)

### Community 68 - "Community 68"
Cohesion: 0.08
Nodes (18): _process_file_for_average, BUG-009: AverageToolbox.is_killed must be threading.Event not plain bool, AverageToolbox, Thread-pool runnable for averaging multiple XPCS datasets.      Manages a file l, Process a batch of files, WorkerSignal, Unit tests for BUG-009: threading.Event cross-thread cancellation in AverageTool, Calling kill() multiple times must not raise and event stays set. (+10 more)

### Community 69 - "Community 69"
Cohesion: 0.06
Nodes (22): Unit tests for ViewerKernel export methods.  This module tests the export functi, Ring ROI addition returns ROI index., Test edge case: export to non-existent directory., Edge case: Export to non-existent directory should be handled., Export should be able to create missing directories., Test G2 ASCII export (VK-006)., Test mock call tracking for export methods., Verify export_g2 mock tracks calls. (+14 more)
...
Cohesion: 0.02
Nodes (66): Light theme should return light-colored matplotlib params., Dark theme should return dark-colored matplotlib params., Matplotlib params should have all required rcParams keys., All matplotlib param values should be valid hex colors., Tests for Matplotlib theme parameter generation., Tests for PyQtGraph theme integration., apply_to_pyqtgraph should not raise any errors., apply_to_pyqtgraph should set PyQtGraph config options. (+58 more)
...
Cohesion: 0.22
Nodes (7): get(), Get or create a lock for a specific file.          Tracks last-access time per e, get the values for the various keys listed in fields for a single     file;, Test suite for get() function., Test getting simple field from HDF5 file., Test getting field with slice., TestGetFunction

### Community 84 - "Community 84"
Cohesion: 0.22
Nodes (7): GraphicsLayoutWidget, ImageView, PlotWidgetDev, QListView, QStatusBar, Set the main window status bar for simple progress display., plot_twotime_g2
...
Cohesion: 0.10
Nodes (15): isolated_test_environment, Create reliable test environment with isolation., reliable_test_environment(), isolated_test_environment(), isolation_manager(), Perform comprehensive cleanup of all registered resources., Provide test isolation manager with automatic cleanup., Context manager for completely isolated test environment. (+7 more)
...
Cohesion: 0.03
Nodes (69): Tests for backend detection and initialization.  Tests FR-001: Automatic device, Test backend detection and initialization., Test that get_backend returns a BackendProtocol instance., Test float64 configuration (FR-003)., Test that JAX is configured for float64., Test that NumPy uses float64 by default., Test that backend has all required properties., Test NumPy backend has correct properties. (+61 more)
...
Cohesion: 0.07
Nodes (22): Generate ArviZ diagnostic plots.          Parameters         ----------, _extract_figure(), generate_arviz_diagnostics(), Extract matplotlib Figure from ArviZ 1.0 PlotCollection/PlotMatrix or legacy axe, Generate complete ArviZ diagnostic suite (FR-013).      Plots generated:     1., FR-013: generate_arviz_diagnostics with 6 standard plots, T093: ArviZ diagnostic plot generation test, Tests for ArviZ diagnostic plot generation (T093).  Tests for generate_arviz_dia (+14 more)
...
Cohesion: 0.05
Nodes (30): Verify FitResult.samples preserves param_names ordering.      Root cause: _build, FitResult stores canonical param_names list., Legacy FitResults without param_names get an empty list., plot_posterior_predictive must call model with correct arg order.          Regre, TestBugH_SamplesKeyOrder, plot_posterior_predictive(), Plot Bayesian fit with posterior credible interval (FR-014).      Parameters, FR-014: Bayesian fit visualization with credible intervals (+22 more)
...
Cohesion: 0.03
Nodes (41): End-to-end tests for visualization workflow., Test visualization generation and export workflow., TestVisualizationWorkflow, _compute_fit_line(), Assemble Bayesian fitting results into NLSQ-compatible fit_summary format.  Conv, Compute fitted curve from Bayesian posterior means., JAX-accelerated NLSQ solver using the nlsq library.  This module provides nonlin, Result dataclasses for Bayesian fitting.  This module defines the data structure (+33 more)
...
Cohesion: 0.10
Nodes (11): ADR-004 Backend Abstraction, ADR-001 JAX Migration, module.twotime, pi(), JAX backend implementation with GPU and JIT support.  This backend provides GPU-, supports_gpu(), xpcsviewer.backends, NumPy backend implementation (CPU fallback).  This backend provides the baseline (+3 more)
...
Cohesion: 0.12
Nodes (19): JAX replacements for SciPy functions used in the SimpleMask module.  Provides JA, interp2d_jax(), JAX replacements for scipy.interpolate functions using interpax.  This module pr, 2D interpolation using interpax.      Parameters     ----------     xq, yq : arr, _convolve_1d(), gaussian_filter(), gaussian_filter1d(), _gaussian_filter_1d_jax() (+11 more)
...
Cohesion: 0.04
Nodes (61): ensure_backend_array(), ensure_numpy(), Convert any array type to NumPy for I/O boundaries.      Use this function at bo, Convert array to the backend's array type.      Use this function when receiving, bool_, minimize_with_grad(), Minimize objective function using gradient descent.      Simple gradient descent, double_exp() (+53 more)
...
Cohesion: 0.08
Nodes (22): Thread, cleanup_system_shutdown(), CleanupScheduler, OptimizedCleanupSystem, Schedules and manages cleanup operations., Schedule a cleanup task., Execute all pending cleanup tasks., Execute all pending cleanup tasks.          Tasks are collected under the lock b (+14 more)

### Community 121 - "Community 121"
Cohesion: 0.07
Nodes (18): _make_hdf5_g2_file(), BUG-003: NLSQ exception handler returns sentinel with is_fallback=True, converge, BUG-023: Failed NLSQResult metrics are NaN, distinguishable from bad-but-converg, BUG-025: FitDiagnostics __post_init__ rejects negative divergences., BUG-025: FitDiagnostics __post_init__ rejects negative ESS values., BUG-024: FitResult __post_init__ rejects empty samples dict., BUG-024: FitResult __post_init__ rejects inconsistent sample array shapes., Create a minimal HDF5 file containing G2 data for integration tests.      Return (+10 more)
...
Cohesion: 0.06
Nodes (19): BackendProtocol, Compute minimum along axis., Protocol defining the backend interface for array operations.      Both NumPyBac, Element-wise logical NOT., Return indices of non-zero elements., Element-wise square root., JIT compile function (no-op for NumPy)., Return gradient function (raises for NumPy). (+11 more)
...
Cohesion: 0.11
Nodes (25): Formatter, get_logger(), log_system_info(), log_timing(), LoggingContext(), RateLimitedLogger(), Setup basic XPCS Viewer utilities.      Parameters     ----------     log_level, Lazy import wrapper for get_logger to avoid circular imports. (+17 more)
...
Cohesion: 0.10
Nodes (16): Filter, Structured file formatter with detailed context information.      Features:, StructuredFileFormatter, LoggingConfig, Get application version using importlib.metadata to avoid circular imports., Configure the logging system., Create session context filter if enabled., Setup colored console logging handler. (+8 more)
...
Cohesion: 0.08
Nodes (17): get_object_registry(), ObjectRegistry, Get or create the global object registry., Register an object for cleanup tracking., Registry for tracking objects that need cleanup., Register an object for tracking., Unregister an object., Clear all registered objects, calling close() on each (P1-16). (+9 more)

### Community 136 - "Community 136"
Cohesion: 0.03
Nodes (70): Schema definitions and validators for XPCS data structures.  This module provide, Unit tests for XPCS schema validators.  This module tests the schema validation, Invalid phis unit should raise ValueError., Test QMapSchema shape validation., Mismatched sqmap/dqmap shapes should raise ValueError., Mismatched mask shape should raise ValueError., Test G2Data schema validation., Valid G2Data instantiation. (+62 more)
...
Cohesion: 0.11
Nodes (18): ImageViewPlotItem, configure_pyqtgraph_for_qt_compatibility(), create_imageview_dev(), create_imageview_plotitem(), create_safe_imageview(), LegacyConnectionDetector, Qt Signal/Slot Connection Fixes for PyQtGraph Integration.  This module provides, Safely disconnect a signal from a slot.      Args:         signal: Qt signal (+10 more)
...
Cohesion: 0.11
Nodes (18): run_benchmark, PlaceholderModule, XPCS analysis modules.  This package contains specialized modules for X-ray Phot, Placeholder module for documentation builds., get_pyqtgraph_anchor_params(), _log_array_dims(), offset_intensity(), pg_plot() (+10 more)
...
Cohesion: 0.09
Nodes (22): QSS files should not use outline, outline-offset, or letter-spacing., Path, Atomic file I/O utilities.  Provides ``safe_json_write`` which writes JSON data, Write *data* as JSON to *path* atomically.      Creates the parent directory if, safe_json_write(), ArtifactManager, collect_test_artifacts(), Manage test artifacts for CI/CD systems. (+14 more)

### Community 174 - "Community 174"
Cohesion: 0.12
Nodes (6): Unit tests for Qmap Colormap Selector (Feature 2).  Tests the colormap dropdown, Tests for signal connection between combobox and plot update., Create a mock viewer with required attributes., Changing colormap should trigger plot update., test_tab20b_has_distinct_colors(), TestQmapColormapSignalConnection
...
Cohesion: 0.13
Nodes (13): Verify ValidationError on any length mismatch in multiple arrays., Test validate_array_compatibility raises ValidationError on mismatch (T019)., Verify ValidationError raised when arrays have different lengths., Verify error message includes array names when provided., Verify returns True when arrays have same length., Verify ValidationError raised for empty arrays., Verify ValidationError raised when no arrays provided., Verify ValidationError raised when all arrays are None. (+5 more)

### Community 200 - "Community 200"
Cohesion: 0.06
Nodes (35): temporary_xpcs_file, AdvancedTestDataFactory, create_minimal_test_data(), create_performance_test_data(), create_realistic_xpcs_dataset(), get_hdf5_manager(), get_test_data_factory(), HDF5TestDataManager (+27 more)
...
Cohesion: 0.10
Nodes (11): Test batch reading with I/O errors., Test chunked dataset reading with errors., Test file info extraction with corrupted metadata., Test metadata reading with various error conditions., Test file I/O error conditions and recovery., Test handling of corrupted HDF5 files., Test handling of files that aren't valid HDF5., Test handling of non-existent files. (+3 more)
...
Cohesion: 0.22
Nodes (8): batch_read_fields(), Optimized batch reading of multiple fields from HDF5 file.      Parameters     -, Test suite for batch_read_fields() function., Test basic batch reading of fields., Test batch reading with missing field., test_batch_read_fields_basic(), test_batch_read_fields_missing_field(), TestBatchReadFields
...
Cohesion: 0.16
Nodes (12): get_cached_memory_monitor, get_cached_memory_monitor(), get_memory_pressure(), get_memory_usage(), MemoryMonitor, Get or create a cached memory monitor instance.      Returns     -------     Mem, Simple memory monitoring utilities using psutil., Get current memory usage information.          Returns         -------         t (+4 more)
...
Cohesion: 0.15
Nodes (15): xpcsviewer.utils.reliability, get_validation_statistics(), Enhanced Validation utilities for XPCS data processing with reliability features, Simple validation that an XPCS file object has a fit_summary attribute.      Arg, Validate that a fit_summary dictionary contains required fields.      Args:, Comprehensive HDF5 file integrity validation with caching.      Args:         fi, Comprehensive scientific array validation with domain-specific checks.      Args, Specialized validation for G2 correlation data.      Args:         g2_array: G2 (+7 more)
...
Cohesion: 0.15
Nodes (7): ImageViewDev, PieROI, r"""     Equilateral triangle ROI subclass with one scale handle and one rotatio, reset the viewbox's limits so updating image won't break the layout;, calculate_safe_levels, clean_c2_for_visualization, plot_twotime
...
Cohesion: 0.05
Nodes (16): ArrayType, Create array filled with specified value., Convert degrees to radians., Convert radians to degrees., Element-wise ceiling., Round to given number of decimals., Find unique elements of array., Stack arrays along new axis. (+8 more)
...
Cohesion: 0.06
Nodes (27): G2 Analysis Algorithm Validation Tests  This module provides comprehensive valid, Test vectorized G2 operations for correctness and performance, Test vectorized baseline correction, Test batch normalization methods, Test ensemble statistics computation, Test error propagation for G2 operations, Test G2 fitting algorithms for accuracy and robustness, Set up fitting test data (+19 more)
...
Cohesion: 0.16
Nodes (6): File, MockH5pyFile, Create comprehensive XPCS HDF5 file., Create basic NeXus structure., Context manager for temporary XPCS file., temporary_xpcs_file()

### Community 244 - "Community 244"
Cohesion: 0.06
Nodes (27): Integration test: batch Bayesian -> dual storage -> plot -> export., End-to-end test of the batch Bayesian pipeline., Setting bayesian_fit_summary must not affect fit_summary on XpcsFile., assemble_fit_summary output must have source='bayesian'., plot_bayesian_all_q must return a Figure., plot_bayesian_all_q must work when data_t_el differs from summary t_el., Exported CSV must contain all Q-bins and parameters., TestBayesianIntegration (+19 more)

### Community 245 - "Community 245"
Cohesion: 0.19
Nodes (13): BUG-F: tauq fit line render, BUG-G: tauq error bars use tauq_tau_err, plot(), plot_pre(), Plot G2 fitting parameters versus q in a 2x2 subplot grid.      Displays contras, Plot relaxation time tau versus scattering vector q.      Renders tau(q) with er, TestTauqErrorBars, TestTauqFallback (+5 more)
...
Cohesion: 0.14
Nodes (10): Algorithm-specific validation tests  This module contains comprehensive validati, Fitting Algorithm Validation Tests  This module provides comprehensive validatio, Property-based test for fitting robustness to noise, Test that fitting results are independent of initial conditions, Test general properties that all fitting algorithms should satisfy, Set up common test parameters, Create test function with known parameters, Test that fitting algorithms recover known parameters accurately (+2 more)
...
Cohesion: 0.22
Nodes (3): MockH5pyFile, Create temporary HDF5 files for testing., temp_hdf5_files()
...
Cohesion: 0.10
Nodes (18): icons_rc (Qt resources), FileLocator, XPCS Viewer - X-ray Photon Correlation Spectroscopy data analysis tool.  This pa, Placeholder XpcsFile class for documentation builds., Placeholder FileLocator class for documentation builds., Placeholder ViewerKernel class for documentation builds., Placeholder ViewerUI class for documentation builds., Placeholder XpcsViewer class for documentation builds. (+10 more)

### Community 281 - "Community 281"
Cohesion: 0.14
Nodes (8): unregister_shortcut should return False for unknown ID., Tests for shortcut registration., Create window and manager for testing., register_shortcut should accept string key sequence., register_shortcut should return False for duplicate ID., register_shortcut should return False without parent., unregister_shortcut should remove shortcut., TestShortcutRegistration
...
Cohesion: 0.02
Nodes (78): Array, check_numpyro(), double_exp_func(), double_exp_model(), _maybe_jit(), power_law_func(), power_law_model(), NumPyro model definitions for G2 correlation fitting.  This module defines proba (+70 more)
...
Cohesion: 0.22
Nodes (8): Tests for validation utility data integrity features.  Tests for Technical Guide, Test legacy validation function is deprecated., Verify legacy function emits DeprecationWarning., TestLegacyValidation, log_array_size_mismatch(), Log a standardized array size mismatch warning.      Args:         file_label: L, Legacy validation that returns tuple instead of raising.      DEPRECATED: Use va, validate_array_compatibility_legacy()
...
Cohesion: 0.24
Nodes (8): _extract_selectors(), Lint tests for QSS stylesheets.  Catches duplicate selectors and unsupported CSS, Detect CSS properties not supported by Qt's QSS engine., Extract (selector, line_number) pairs from QSS text.      Returns normalised sel, Detect duplicate selectors within a single QSS file., Each selector should appear at most once per file., TestQssDuplicateSelectors, TestQssUnsupportedProperties
...
Cohesion: 0.20
Nodes (7): fitting_benchmark_data(), Benchmark tests for JIT-accelerated fitting functions.  Verifies performance imp, Generate data for fitting benchmarks., Benchmark tests for NLSQ JIT performance., Verify NLSQ fitting runs without error and returns valid result., Record timing for NLSQ fitting with JIT., TestNLSQJITPerformance
...
Cohesion: 0.28
Nodes (5): CacheItem, Data caching utilities for XpcsFile.  This module provides LRU caching with memo, Individual cache item with metadata., Update access timestamp and increment access count., Mark item as accessed.

### Community 316 - "Community 316"
Cohesion: 0.14
Nodes (10): manager_with_shortcuts(), Unit tests for ShortcutManager., window_and_manager(), Get list of registered shortcut IDs.          Returns:             List of short, Check if a shortcut ID is registered.          Args:             shortcut_id: ID, Centralized keyboard shortcut manager.      Handles registration, conflict detec, Initialize the ShortcutManager.          Args:             parent: Parent widget, Register a keyboard shortcut.          Args:             shortcut_id: Unique ide (+2 more)
...
Cohesion: 0.06
Nodes (24): Test suite for FileLocator get_xf_list method., Test get_xf_list with no rows specified., Test get_xf_list with specific rows., Test get_xf_list creates cache entries for missing files., Test get_xf_list skips files that failed to load., Test get_xf_list with filter_fitted=True., Test get_xf_list with analysis type filter., Test get_xf_list handles invalid row indices gracefully. (+16 more)
...
Cohesion: 0.25
Nodes (5): Verify _run_mcmc uses init_to_value for constrained warm-start., _run_mcmc must accept an init_params keyword argument., biject_to(constraint).inv maps constrained → unconstrained., _run_mcmc must use init_to_value for warm-start initialization., TestBugA_InitParamsUnconstrained
...
Cohesion: 0.43
Nodes (7): _make_geometry(), _make_tab_widget(), End-to-end regression test for target-file session persistence.  Guards the bug, Finding 2 (adversarial review): even when the data dir is opened via a     RELAT, test_relative_data_path_persists_as_absolute(), test_target_files_survive_restart_from_other_cwd(), SimpleNamespace
...
Cohesion: 0.25
Nodes (5): Integration test for async G2 result handler.      Verifies:     - apply_g2_resu, BUG-014: apply_g2_result uses pre-computed worker result without re-calling plot, BUG-014: apply_g2_result routes worker data to renderer without re-computation., BUG-014: G2PlotWorker produces a result dict with expected keys., TestChain4AsyncArchitecture

### Community 347 - "Community 347"
Cohesion: 0.25
Nodes (5): Scientific tests for colormap visual properties., tab20b colors should be perceptually distinct for ROI visualization., viridis should provide smooth perceptual progression., Gray colormap should be strictly monotonic in luminance., TestColormapVisualProperties
...
Cohesion: 0.33
Nodes (4): __getattr__(), XpcsFile package - modular components for XPCS data handling.  This package prov, MemoryStatus, Container for memory status information.
...
Cohesion: 0.33
Nodes (4): Test basic FileLocator initialization., Test that initialization creates required components., Test suite for FileLocator initialization., TestFileLocatorInit
...
Cohesion: 0.33
Nodes (4): Test suite for FileLocator clear method., Test clear method clears source models., Test that clear method only affects source models., TestFileLocatorClearMethod

### Community 380 - "Community 380"
Cohesion: 0.33
Nodes (4): Test suite for FileLocator caching behavior., Test that cache persists between calls., Test that cache keys use full path format., TestFileLocatorCaching
...
Cohesion: 0.33
Nodes (4): Test suite for FileLocator performance characteristics., Test FileLocator initialization performance., Test that cached access is faster than creation., TestFileLocatorPerformance

### Community 402 - "Community 402"
Cohesion: 0.33
Nodes (4): Test sector ROI addition (VK-009)., VK-009: Sector ROI geometry creation., Sector ROI with various angles., TestAddRoiSector

### Community 403 - "Community 403"
Cohesion: 0.08
Nodes (21): ADR-003 HDF5 Facade, io.hdf5_facade (proposed), get_chunked_dataset(), get_connection(), get_file_info(), HDF5 file reading utilities with connection pooling.  Provides optimized HDF5 fi, Read a large dataset in chunks to manage memory usage.      Parameters     -----, Dynamically adapt pool size based on system memory pressure.          Throttled (+13 more)
...
Cohesion: 0.33
Nodes (4): Test suite for ViewerKernel memory management integration., Test integration with MemoryMonitor., Test memory threshold validation., TestViewerKernelMemoryIntegration
...
Cohesion: 0.12
Nodes (19): Unit tests for plot_themes module., get_theme_colors(), Centralized plotting constants for consistent styling across all plot handlers., Get plot colors for the specified theme.      If theme is None, attempts to get, Apply theme colors to this plot widget.          Parameters         ----------, Apply theme colors to this image view.          Parameters         ----------, Theme system for XPCS-TOOLKIT GUI.  This module provides theming infrastructure, apply_matplotlib_theme() (+11 more)
...
Cohesion: 0.50
Nodes (3): Integration tests for file operations with other GUI components., Test that file loading updates analysis tabs., TestFileOperationIntegration
...
Cohesion: 0.06
Nodes (41): Test explicit backend setting., Test setting NumPy backend explicitly., Test setting JAX backend explicitly., Test setting invalid backend raises ValueError., Test backend name is case-insensitive., Test mathematical operations., TestBackendMathOperations, TestSetBackend (+33 more)
...
- **Why does `XpcsViewer` connect `Community 8` to `Community 1`, `Community 6`, `Community 7`, `Community 139`, `Community 141`, `Community 1039`, `Community 19`, `Community 278`, `Community 279`, `Community 280`, `Community 153`, `Community 1050`, `Community 27`, `Community 26`, `Community 34`, `Community 294`, `Community 38`, `Community 424`, `Community 39`, `Community 429`, `Community 175`, `Community 49`, `Community 52`, `Community 57`, `Community 58`, `Community 185`, `Community 60`, `Community 316`, `Community 319`, `Community 195`, `Community 966`, `Community 457`, `Community 75`, `Community 333`, `Community 337`, `Community 466`, `Community 213`, `Community 982`, `Community 346`, `Community 220`, `Community 351`, `Community 96`, `Community 121`, `Community 101`, `Community 357`, `Community 359`, `Community 233`, `Community 242`, `Community 116`, `Community 244`, `Community 249`, `Community 250`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Why does `XpcsFile` connect `Community 32` to `Community 1`, `Community 899`, `Community 7`, `Community 135`, `Community 10`, `Community 266`, `Community 142`, `Community 14`, `Community 143`, `Community 273`, `Community 19`, `Community 403`, `Community 280`, `Community 25`, `Community 27`, `Community 30`, `Community 294`, `Community 39`, `Community 297`, `Community 45`, `Community 429`, `Community 49`, `Community 190`, `Community 319`, `Community 63`, `Community 67`, `Community 323`, `Community 68`, `Community 74`, `Community 334`, `Community 207`, `Community 208`, `Community 78`, `Community 212`, `Community 982`, `Community 342`, `Community 96`, `Community 224`, `Community 486`, `Community 1002`, `Community 235`, `Community 108`, `Community 244`, `Community 1012`, `Community 118`, `Community 247`, `Community 250`, `Community 253`, `Community 895`?**
  _High betweenness centrality (0.115) - this node is a cross-community bridge._
- **Why does `ViewerKernel` connect `Community 7` to `Community 1`, `Community 8`, `Community 9`, `Community 141`, `Community 142`, `Community 272`, `Community 402`, `Community 405`, `Community 406`, `Community 280`, `Community 32`, `Community 174`, `Community 431`, `Community 49`, `Community 188`, `Community 190`, `Community 319`, `Community 68`, `Community 69`, `Community 206`, `Community 80`, `Community 982`, `Community 86`, `Community 347`, `Community 248`, `Community 252`?**
...
- **What connects `Enhanced mock for Qt modules that provides common Qt patterns`, `Setup function for Sphinx extension.`, `# NOTE: Only mock EXTERNAL dependencies here (Qt, pyqtgraph, etc.).` to the rest of the system?**
  _5614 weakly-connected nodes found - possible documentation gaps or missing edges._